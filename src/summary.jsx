...
const Summary = ({ setShowPage }) => {
  ...
  return (
    <div className="relative ">
      ...
      <div
        className={
          "relative w-[360px] h-[416px] mt-[20px] pt-[29px]  ml-[37px] rounded-[16px] text-black bg-white  shadow-[0_20px_30px_0_rgba(16,14,35,0.06)] "
        }
      >
        <div className="overflow-y-auto  h-[280px] px-[21px]">
        ...
        <div
          ...
          className="mr-[20px] absolute cursor-pointer left-0 bottom-0 rounded-b-[16px] h-[43px] w-[340px] bg-[#198DDB] text-white flex items-center justify-center text-[16px] font-bold"
